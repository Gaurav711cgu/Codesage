    ...
    <>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
          {/* Logo */}
          <Link to="/" className="flex items-center gap-2 group" aria-label="CodeSage Home">
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
              <defs>
                <linearGradient id="brain-grad" x1="0" y1="0" x2="28" y2="28">
                  <stop offset="0%" stopColor="#3B82F6" />
                  <stop offset="100%" stopColor="#60A5FA" />
                </linearGradient>
              </defs>
              <path d="M14 3C8.5 3 4 7.5 4 13c0 3.5 1.8 6.6 4.5 8.4L10 24l4-2 4 2 1.5-2.6C22.2 19.6 24 16.5 24 13c0-5.5-4.5-10-10-10z" stroke="url(#brain-grad)" strokeWidth="1.8" fill="none"/>
              <text x="8" y="15.5" fill="url(#brain-grad)" fontSize="7" fontFamily="JetBrains Mono" fontWeight="700">{'{}'}</text>
            </svg>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden sm:flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm transition-colors duration-150"
            ...
            <Link
              ...
              className="hidden sm:inline-flex px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-150 hover:translate-y-[-1px]"
          ...
          >
            {NAV_LINKS.map((link) => {
              ...
              return (
                <Link
                  ...
                  className="block text-base px-4 py-3 rounded-lg transition-all duration-150 active:scale-98"
                  style={{
            ...
            <div className="pt-2 mt-2" style={{ borderTop: '1px solid var(--cs-border)' }}>
              <Link 
                ...
                className="block text-base px-4 py-3 rounded-lg transition-colors duration-150" 
            ...
            <Link 
              ...
              className="block w-full text-center px-4 py-3 rounded-lg text-base font-semibold mt-3 text-white transition-transform duration-150 active:scale-98"
